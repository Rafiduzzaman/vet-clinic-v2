...
> This is a project called vet_clinic that uses database

**[Vet_clinic]** is a database implemented webpage
...
> Learn about queries and database connection
...
git clone https://github.com/Rafiduzzaman/vet-clinic.git

### Usage

To run the project, execute the following command:

Run in PostGreSql 16
